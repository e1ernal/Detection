...
extension MainVC: UITableViewDelegate, UITableViewDataSource {
    func setupTableView() {
        ...
        signTableView.register(Cells.regular.getClass, forCellReuseIdentifier: Cells.regular.getId)
        signTableView.register(Cells.signDetection.getClass, forCellReuseIdentifier: Cells.signDetection.getId)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case sectionImageNumber:
            ...
            case 0:
                ...
                return cell
            case 1:
                let cell = tableView.dequeueReusableCell(withIdentifier: Cells.regular.getId,
                                                         for: indexPath)
                ...
                return cell
            default:
                return tableView.dequeueReusableCell(withIdentifier: Cells.regular.getId,
                                                     for: indexPath)
            }
